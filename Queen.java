...
public class Queen extends ChessComponent {
	...
	private Image image;
	public Queen(ChessboardPoint chessboardPoint, Point location, ChessColor chessColor,
	...
	public void loadResource() throws IOException {
		// TODO Auto-generated method stub
		if (WHITE == null) {
            WHITE = ImageIO.read(new File("./images/queen-white.png"));
        }

        if (BLACK == null) {
            BLACK = ImageIO.read(new File("./images/queen-black.png"));
        }

	}
	public void changeResource()throws IOException{
		WHITE = ImageIO.read(new File("./images/queen-white2.png"));
		BLACK = ImageIO.read(new File("./images/queen-black2.png"));
	}
