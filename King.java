...
public class King extends ChessComponent {
	...
	private Image image;
	public King(ChessboardPoint chessboardPoint, Point location, ChessColor chessColor,
	...
	public void loadResource() throws IOException {
		// TODO Auto-generated method stub
		if (WHITE == null) {
            WHITE = ImageIO.read(new File("./images/king-white.png"));
        }

        if (BLACK == null) {
           BLACK = ImageIO.read(new File("./images/king-black.png"));
        }

	}
	public void changeResource()throws IOException{
		WHITE = ImageIO.read(new File("./images/king-white2.png"));

		BLACK = ImageIO.read(new File("./images/king-black2.png"));
	}
